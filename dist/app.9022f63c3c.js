...
const scriptEl = document.querySelector('script[src$="app.9022f63c3c.js"]');
if (scriptEl) {
...
const appScript = document.querySelector('script[src$="app.9022f63c3c.js"]');
const appUrl = appScript ? appScript.src : new URL("app.9022f63c3c.js", window.location.href).href;
